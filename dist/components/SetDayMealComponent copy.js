...
var SetDayMealComponent = (_dec = (0, _framework.Component)(), _dec2 = (0, _framework.Intents)('YesIntent'), _dec3 = (0, _framework.Intents)('NoIntent'), _dec4 = (0, _framework.Intents)('SetBreakfastIntent'), _dec5 = (0, _framework.Intents)('SetMiddayIntent'), _dec6 = (0, _framework.Intents)('SetLunchIntent'), _dec7 = (0, _framework.Intents)('SetBudgetIntent'), _dec(_class = (_class2 = /*#__PURE__*/function (_BaseComponent) {
  ...
  (0, _createClass2["default"])(SetDayMealComponent, [{
    ...
    value: function setBudget() {
      ...
      //  console.log(budget)
      return this.$send({
        message: "Budget value is ".concat(this.$entities.budget.value)
      });
    } // UNHANDLED() {
    //   return this.START();
    // }
