...
var SetBudgetComponent = (_dec = (0, _framework.Component)(), _dec2 = (0, _framework.Intents)('YesIntent'), _dec3 = (0, _framework.Intents)('SetBudgetIntent'), _dec4 = (0, _framework.Intents)('NoIntent'), _dec(_class = (_class2 = /*#__PURE__*/function (_BaseComponent) {
  ...
  (0, _createClass2["default"])(SetBudgetComponent, [{
    ...
    value: function setBudget() {
      var budget = this.$entities.budget.value;
      console.log(budget);
      return this.$send({
        message: 'Budget value is ' + budget
      });
    }
  }, {
    key: "dontSetBudget",
...
}(_framework.BaseComponent), ((0, _applyDecoratedDescriptor2["default"])(_class2.prototype, "whatBudget", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "whatBudget"), _class2.prototype), (0, _applyDecoratedDescriptor2["default"])(_class2.prototype, "setBudget", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "setBudget"), _class2.prototype), (0, _applyDecoratedDescriptor2["default"])(_class2.prototype, "dontSetBudget", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "dontSetBudget"), _class2.prototype)), _class2)) || _class);
